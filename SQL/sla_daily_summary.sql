...
BEGIN
    ...
    l_reginfo := cq_notification$_reg_info (
        'query_callback_for_sla_daily_summ_change',
    ...
    OPEN l_cursor FOR
       select * from daily_sla_smry_v order by SLA_DELIVERY_TS desc;
    CLOSE l_cursor;
...
CREATE OR REPLACE PROCEDURE query_callback_for_sla_daily_summ_change(
...
BEGIN
    ...
    l_req := utl_http.begin_request(
        url    => '10.135.240.200:3007/api/slas/daily/summary/db/change',
        method => 'GET'
    );

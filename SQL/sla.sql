...
BEGIN
    ...
    OPEN l_cursor FOR
        select  * from Sla_delivery_log where rownum <= 100 order by SLA_DELIVERY_TS desc;
    CLOSE l_cursor;
...
CREATE OR REPLACE PROCEDURE query_callback_for_sla_change(
...
BEGIN
    ...
    l_req := utl_http.begin_request(
        url    => '10.135.240.200:3007/api/slas/db/change',
        method => 'GET'
    );

...
BEGIN
    ...
    l_reginfo := cq_notification$_reg_info (
        'query_callback_for_int_flow_change',
    ...
    OPEN l_cursor FOR
        select * from Sla_intg_flow_depend_config order by SLA_CONFIG_KEY desc;
    CLOSE l_cursor;
...
CREATE OR REPLACE PROCEDURE query_callback_for_int_flow_change(
...
BEGIN
    ...
    l_req := utl_http.begin_request(
        url    => '10.135.240.200:3007/api/slas/integration/flow/db/change',
        method => 'GET'
    );
